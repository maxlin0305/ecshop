...
return [
    ...
    'zgj_app_sign_token' => env('ZGJ_APP_SIGN_TOKEN',''),
    'zgj_app_url'    => env('ZGJ_APP_URL','https://tinside.smtengo.com'),
    'zgj_app_key'    => env('ZGJ_APP_KEY','aLjyMhsaMmKsChOEOFccqjTHFUMXzJSw'),
    'zgj_app_secret' => env('ZGJ_APP_SECRET','fzyCEryeGSalydJakjRDduHGIOwRcAqvImOnZZUKXPbFbXCIMGeLLuCVErsxkIhL'),
];
