...
class PushMessageRepository extends EntityRepository
{
    public $table = "push_message";
    public $cols = ['id','company_id','merchant_id','distributor_id','user_id','msg_name','msg_type','content','is_read','create_time','update_time'];
