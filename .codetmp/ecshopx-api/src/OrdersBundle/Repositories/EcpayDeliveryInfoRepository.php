...
class EcpayDeliveryInfoRepository extends EntityRepository
{
    public $table = "ecpay_delivery_info";
    public $cols = ['id','logistics_id','booking_note','cvs_payment_no','cvs_validation_no','goods_amount','logistics_type','logistics_subtype','merchant_id','merchant_tradeno','receiver_address','receiver_mobile','receiver_email','receiver_name','receiver_phone','rtn_code','rtn_msg','update_status_date','created_at','updated_at'];
    /**
     * 新增
     *
     * @param array $data
