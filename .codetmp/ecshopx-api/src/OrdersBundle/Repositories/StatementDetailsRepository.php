...
class StatementDetailsRepository extends EntityRepository
{
    ...
    public $cols = ['id', 'company_id', 'merchant_id', 'distributor_id', 'statement_id', 'statement_no', 'order_id', 'total_fee', 'freight_fee', 'intra_city_freight_fee', 'rebate_fee', 'refund_fee', 'statement_fee', 'pay_type'];
    /**
     * 新增
     *
     * @param array $data
