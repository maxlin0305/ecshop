...
class OrdersDeliveryRepository extends EntityRepository
{
    ...
    public $cols = ['orders_delivery_id','company_id','order_id','user_id','delivery_corp','logistics_type','delivery_corp_name','delivery_code','delivery_time','delivery_corp_source','receiver_mobile','package_type','created','updated'];
    /**
     * 新增
     *
     * @param array $data
