...
class CommunityChiefRepository extends EntityRepository
{
    ...
    public $cols = ['chief_id','company_id','chief_name', 'chief_avatar', 'chief_mobile', 'chief_desc',
        'chief_intro','province','city','area','regions_id','regions','address','lat','lng','user_id','created_at','updated_at', 'alipay_name', 'alipay_account', 'bank_name', 'bankcard_no', 'bank_branch', 'bank_household_name'];
    /**
     * 新增
     *
     * @param array $data
