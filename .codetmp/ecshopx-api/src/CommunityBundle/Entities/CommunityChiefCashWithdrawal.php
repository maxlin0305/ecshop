...
class CommunityChiefCashWithdrawal
{
     ...
     * @var string
     *
     * @ORM\Column(name="bank_household_name", nullable=true, type="string", options={"comment":"开户名"})
     */
    private $bank_household_name;
    /**
     * @var string
     *
     * @ORM\Column(name="bank_branch", nullable=true, type="string", options={"comment":"开户行"})
     */
    private $bank_branch;
