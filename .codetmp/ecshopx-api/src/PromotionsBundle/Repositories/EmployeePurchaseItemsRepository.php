...
class EmployeePurchaseItemsRepository extends EntityRepository
{

    public $table = "promotions_employee_purchase_items";
    public $cols = ['purchase_id','company_id','item_id','item_type','limit_fee','limit_num','created','updated'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new EmployeePurchaseItems();
