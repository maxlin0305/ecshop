...
class EmployeePurchaseReluserRepository extends EntityRepository
{

    public $table = "promotions_employee_purchase_reluser";
    public $cols = ['id','company_id','purchase_id','employee_user_id','dependents_user_id','created','updated'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new EmployeePurchaseReluser();
