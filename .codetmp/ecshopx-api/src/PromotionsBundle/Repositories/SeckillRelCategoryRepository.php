...
class SeckillRelCategoryRepository extends EntityRepository
{
    public $table = "promotions_seckill_rel_category";
    public $cols = ['id','seckill_id','category_id','company_id','category_level'];
    /**
     * 新增
     *
     * @param array $data
