    ...
    public function applyCashWithdrawal($data)
    {
        ...
        if ($data['pay_type'] == 'bankcard') {
            if (isset($chief['bank_name']) && isset($chief['bankcard_no'])) {
                ...
                $data['bank_branch'] = $chief['bank_branch'];
                $data['bank_household_name'] = $chief['bank_household_name'];
            } else {
        ...
        $insertData = [
            ...
            'bank_branch' => $data['pay_type'] == 'bankcard' ? $data['bank_branch'] : null,
            'bank_household_name' => $data['pay_type'] == 'bankcard' ? $data['bank_household_name'] : null,
            'wxa_appid' => $data['wxa_appid'] == null? 0:$data['wxa_appid'],
