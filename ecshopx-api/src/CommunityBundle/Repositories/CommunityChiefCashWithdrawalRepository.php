...
class CommunityChiefCashWithdrawalRepository extends EntityRepository
{
    ...
    private function setColumnNamesData($entity, $data)
    {
        ...
        if (isset($data["bank_branch"]) && $data["bank_branch"]) {
            $entity->setBankBranch($data["bank_branch"]);
        }
        if (isset($data["bank_household_name"]) && $data["bank_household_name"]) {
            $entity->setBankHouseholdName($data["bank_household_name"]);
        }
    ...
    private function getColumnNamesData($entity)
    {
        return [
            ...
            'bank_branch' => $entity->getBankBranch(),
            'bank_household_name' => $entity->getBankHouseholdName(),
