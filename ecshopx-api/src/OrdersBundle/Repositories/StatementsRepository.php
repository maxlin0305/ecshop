...
class StatementsRepository extends EntityRepository
{
    ...
    public $cols = ['id', 'company_id', 'merchant_id', 'distributor_id', 'statement_no', 'order_num', 'total_fee', 'freight_fee', 'intra_city_freight_fee', 'rebate_fee', 'refund_fee', 'statement_fee', 'start_time', 'end_time', 'confirm_time', 'statement_time', 'statement_status'];
    /**
     * 新增
     *
     * @param array $data
