...
class MpsFeedLogRepository extends EntityRepository
{

    public $table = "wsugc_mps_feedlogs";
    public $cols = ['log_id','file_name','unique_id','bn','line','status','message','created','updated'];
    /**
     * 新增
     *
     * @param array $data
