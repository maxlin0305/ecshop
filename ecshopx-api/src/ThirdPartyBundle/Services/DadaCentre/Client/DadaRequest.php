...
namespace ThirdPartyBundle\Services\DadaCentre\Client;

use ThirdPartyBundle\Services\DadaCentre\Config\Config;
use ThirdPartyBundle\Services\DadaCentre\Config\Constant;
...
class DadaRequest
{
    ...
    public function parseResponseData($arr)
    {
        ...
        if (empty($arr)) {
            ...
            $resp->setResult($data['result'] ?? false);
        }
        return $resp;
    }
