...
class PagesTemplateServices
{
    ...
    public function sync($params)
    {
        ...
        foreach ($distributor_ids as $key => $distributor_id) {
            ...
            $this->distributorPagesTemplate($distributor_id, $enforce_sync_status, $company_id, $template_title, $template_pic,
                $weapp_pages, $element_edit_status, $pages_template_id, $template_name);
        }
