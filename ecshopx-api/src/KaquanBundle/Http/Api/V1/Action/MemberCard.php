...
class MemberCard extends BaseController
{
    ...
    {
        return $this->response->array($this->getSettingsNew());
    }
     ...
     * 获取会员卡设置
     */
    public function getSettingsNew()
    {
    ...
    {
        $statisticalMonth = $request->input('statistical_month', 1);//统计月份
        $redis = app('redis')->connection('default');
        $redis->set("membercard-settings", json_encode([
