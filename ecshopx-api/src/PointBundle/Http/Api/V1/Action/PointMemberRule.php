...
class PointMemberRule extends Controller
{
    ...
    public function save(Request $request)
    {
        ...
        $rules = [
            ...
            'mi_is_open' => ['required|in:1,2','是否开启到期提醒[1:开启/2：关闭]'],//是否开启到期提醒[1:开启/2：关闭]
//            'mi_start_date' =>'',
//            'mi_end_date' =>'',
            'mi_multiple' =>['numeric|min:1','倍数必须为整数并且大于1'],//倍数
//            'mi_record_activities' =>'',//活动文案
            'mi_expiration_reminder' =>['required|in:1,2','是否开启到期提醒[1:开启/2：关闭]'],//是否开启到期提醒[1:开启/2：关闭]
            'mi_reminder_copy' =>'',//提醒文案
            'mi_zeroing_time' =>['numeric','清零时间必须为整数'],//清零时间(天,0不清零)
        ];
