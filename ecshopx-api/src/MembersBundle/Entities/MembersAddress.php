...
class MembersAddress
{
     ...
     * @var string
     *
     * @ORM\Column(name="smart_butler_address", type="string", options={"comment":"smart_butler_address","default": ""})
     */
    private $smart_butler_address;
     ...
     * @return MembersAddress
     */
    public function setSmartButlerAddress($address)
    {
        $this->smart_butler_address = $address;
     ...
     * @return string
     */
    public function getSmartButlerAddress()
    {
        return $this->smart_butler_address;
    }
}
