...
{
    public $table = "wechat_weapp_customize_page";
    public $cols = ['id','template_name','company_id','page_name','page_description','page_share_title','page_share_desc','page_share_imageUrl','is_open', 'page_type'];
    /**
     * 新增
     *
     * @param array $data
