...
class EmployeePurchaseRepository extends EntityRepository
{

    public $table = "promotions_employee_purchase";
    public $cols = ['purchase_id','company_id','purchase_name','ad_pic','used_roles','employee_limitfee','is_share_limitfee','dependents_limitfee','dependents_limit','minimum_amount','begin_time','end_time','created','updated'];
    /**
     * 新增
     *
     * @param array $data
