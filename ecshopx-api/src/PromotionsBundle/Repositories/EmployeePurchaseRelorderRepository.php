...
use PromotionsBundle\Entities\EmployeePurchaseRelorder;
...
class EmployeePurchaseRelorderRepository extends EntityRepository
{

    public $table = "promotions_employee_purchase_relorder";
    public $cols = ['id','company_id','purchase_id','order_id','order_item_id','user_id','purchase_item_id','num','fee','redis_key','created','updated'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new EmployeePurchaseRelorder();
