...
$api->version('v1', function ($api) {
    ...
    $api->group(['prefix' => 'h5app', 'namespace' => 'OrdersBundle\Http\FrontApi\V1\Action', 'middleware' => 'frontnoauth:h5app', 'providers' => 'jwt'], function($api) {
        ...
        # 获取绿界token
        $api->post('/wxapp/payment/get_token', ['name' => '获取厂商token', 'as' => 'front.wxapp.payment.token',  'uses'=>'WxappPayment@getToken']);

        # 根据payToken发起交易支付
        $api->post('/wxapp/payment/pay', ['name' => '绿界支付', 'as' => 'front.wxapp.payment.pay',  'uses'=>'WxappPayment@paymentByPayToken']);
    });
});
/* ↑↑↑↑↑ ↑↑↑↑↑ ↑↑↑↑↑ ↑↑↑↑↑ taro小程序、h5、app端、pc端 ↑↑↑↑↑ ↑↑↑↑↑ ↑↑↑↑↑ ↑↑↑↑↑ */
